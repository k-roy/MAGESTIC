...
# 20240411_Twist_200mer_subpool_1-16_step_1_libraries/
...
RAW_DATA_DIR=$PARENT_DIR"raw_data/$PROJECT_PATH"
SCRIPTS_DIR=$PARENT_DIR"scripts_and_keyfiles/general_scripts/"

INTERMEDIATE_DATA_DIR=$PARENT_DIR"intermediate_data/$PROJECT_PATH"
...
echo $prefix; 
bbduk.sh in1=$FASTQ_DIR$prefix"_R1.fastq.gz" in2=$FASTQ_DIR$prefix"_R2.fastq.gz" out1=$TRIMMED_READS_DIR$prefix"_trimmed_R1.fastq.gz" out2=$TRIMMED_READS_DIR$prefix"_trimmed_R2.fastq.gz" literal=AGATCGGAAGAGCGTCGTGTAGGGAAAGA overwrite=true ftl=20 ktrim=r k=23 mink=11 hdist=1 tpe tbo; 
bbmerge.sh in1=$TRIMMED_READS_DIR$prefix"_trimmed_R1.fastq.gz" in2=$TRIMMED_READS_DIR$prefix"_trimmed_R2.fastq.gz" out=$MERGED_READS_DIR$prefix"_trimmed_merged.fastq" outu=$UNMERGED_READS_DIR$prefix"_trimmed_unmerged_R1.fastq" outu2=$UNMERGED_READS_DIR$prefix"_trimmed_unmerged_R2.fastq" overwrite=true; 
