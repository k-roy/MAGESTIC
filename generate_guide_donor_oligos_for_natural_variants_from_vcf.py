...
DIR = '/path/to/Dropbox/steinmetz_lab/Scer_natural_variants/'
genome_filename = '/path/to/Dropbox/saccharomyces_cerevisiae_sequence.fasta'
...
indel_vcf_infilename =  DIR + strain + '_indels_WAVE.vcf' ## '/path/to/Dropbox/steinmetz_lab/variants_Wave_LinGEN/rm_indel_test.txt' ## 
SNP_vcf_infilename = DIR + strain + '_snps_WAVE.vcf' ## '/path/to/Dropbox/steinmetz_lab/variants_Wave_LinGEN/rm11_snps_test.txt'   ## 
