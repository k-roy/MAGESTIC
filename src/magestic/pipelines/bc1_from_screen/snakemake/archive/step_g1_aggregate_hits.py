#!/usr/bin/env python3
"""
Step G1: Aggregate Hit Calling Results Across Comparisons

Combines per-comparison hit calling results from step_g0 and runs:
...
This step runs AFTER individual comparison hit calling (step_g0) and provides
additional validation and summarization across the entire screen.

Usage:
    python step_g1_aggregate_hits.py \\
